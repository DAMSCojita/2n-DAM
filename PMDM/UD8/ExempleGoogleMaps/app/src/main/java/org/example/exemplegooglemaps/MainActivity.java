package org.example.exemplegooglemaps;
...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mapa.addMarker(new MarkerOptions().position(Ramis).title("Ramis").snippet("IES Joan Ramis i Ramis").icon(BitmapDescriptorFactory.fromResource(android.R.drawable.ic_menu_compass)).anchor(0.5f, 0.5f));
    ...
    @Override
    public void onMapClick(LatLng puntPitjat) {
