...
# Creamos una función para agregar un estudiante.
...
# Creamos una función para calcular el promedio.
def calcular_promedio():
    ...
    if nombre not in estudiantes:  # Verificamos si el estudiante no existe en el diccionario.
        ...
        return  # Terminamos la función si el estudiante no existe.
...
def encontrar_mejor_promedio():
    if not estudiantes:  # Verificamos si no hay estudiantes registrados en el diccionario.
        ...
        return  # Terminamos la función si no hay estudiantes.
...
def menu_principal():
    while True:  # Bucle infinito que mantiene el menú activo hasta que el usuario decida salir.
        ...
        if opcion == 1:
            agregar_estudiante()  # Llamamos a la función para agregar un nuevo estudiante.
        elif opcion == 2:
            
            calcular_promedio()  # Llamamos a la función para calcular el promedio de un estudiante.
        elif opcion == 3:
            encontrar_mejor_promedio()  # Llamamos a la función para encontrar al estudiante con el mejor promedio.
        elif opcion == 4:
            print("Saliendo del programa...")  # Mostramos un mensaje indicando que el programa está cerrando.
