...
namespace RentalCarDefinitiu
{
    public partial class FormCargos : Form
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                cargoBindingSource.RemoveCurrent(); // Eliminem el registre actual.
                cargoTableAdapter.Update(rentalCarDataSet.Cargo); // Actualitzem la base de dades.
            }
        }
        ...
        private void picConfirmar_Click_1(object sender, EventArgs e)
        {
            ...
            this.cargoBindingSource.EndEdit(); // Apliquem les dades.
        ...
        {
            cargoBindingSource.CancelEdit(); // Cancel·lem el registre.
            modoEdicion = false;
            verificaVisibilidad(); // Trucam al mètode per verificar la visibilidad.
        }
